...
export default class Manual extends React.Component {
    constructor() {
        super()
        this.state = {
            shown_sidebarcontent: false,
            shown_guide: false,
        }
        this.toggleSidebarcontent = this.toggleSidebarcontent.bind(this)
        this.toggleGuide = this.toggleGuide.bind(this)
    }
    toggleSidebarcontent() {
        this.setState({
            shown_sidebarcontent: !this.state.shown_sidebarcontent
        })
    }
    toggleGuide() {
        this.setState({
    ...
    render() {
        let arrow = <BiDownArrow />
        let arrow_guide = <BiDownArrow />
        if (this.state.shown_sidebarcontent == true) {
            arrow = <BiUpArrow />
        }
        if (this.state.shown_guide == true) {
            arrow_guide = <BiUpArrow />
        }
        return (
                ...
                <div className="wrapper">
                    <div className="manual">
                        ...
                        <div className="text-arrow">
                            ...
                            <div onClick={this.toggleSidebarcontent}>
                                {arrow}
                            </div>
                        </div>
                        <hr />
                        <UnmountClosed isOpened={this.state.shown_sidebarcontent}>
                        ...
                        <div className="text-arrow">
                            ...
                            <div onClick={this.toggleGuide}>
                                {arrow_guide}
                            </div>
                        </div>
                        <hr />
                        <UnmountClosed isOpened={this.state.shown_guide}>
